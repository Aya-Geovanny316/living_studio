...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="font-sans text-gray-900 antialiased">
        <div class="min-h-screen flex flex-col sm:justify-center items-center pt-6 sm:pt-0 bg-ls-light">
            <div>
                <a href="/">
                    <div class="flex h-16 w-16 items-center justify-center rounded-full bg-ls-indigo text-white font-display">GT</div>
                </a>
            </div>
